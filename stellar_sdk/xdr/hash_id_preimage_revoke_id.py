...
class HashIDPreimageRevokeID:
    ...
    def __hash__(self):
        return hash((self.source_account, self.seq_num, self.op_num, self.liquidity_pool_id, self.asset,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.source_account== other.source_account and self.seq_num== other.seq_num and self.op_num== other.op_num and self.liquidity_pool_id== other.liquidity_pool_id and self.asset== other.asset
    def __str__(self):
        out = [
