...
class ClawbackClaimableBalanceResult:
    ...
    def pack(self, packer: Packer) -> None:
        ...
        if self.code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_SUCCESS:
            return
        if self.code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_DOES_NOT_EXIST:
            return
        if self.code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_NOT_ISSUER:
            return
    ...
    def unpack(cls, unpacker: Unpacker) -> ClawbackClaimableBalanceResult:
        ...
        if code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_SUCCESS:
            return cls(code=code)
        if code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_DOES_NOT_EXIST:
            return cls(code=code)
        if code == ClawbackClaimableBalanceResultCode.CLAWBACK_CLAIMABLE_BALANCE_NOT_ISSUER:
            return cls(code=code)
