...
class ConfigSettingContractEventsV0:
    ...
    def __hash__(self):
        return hash((self.tx_max_contract_events_size_bytes, self.fee_contract_events1_kb,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.tx_max_contract_events_size_bytes== other.tx_max_contract_events_size_bytes and self.fee_contract_events1_kb== other.fee_contract_events1_kb
    def __str__(self):
        out = [
