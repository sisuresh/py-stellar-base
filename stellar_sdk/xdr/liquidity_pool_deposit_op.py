...
class LiquidityPoolDepositOp:
    ...
    def __hash__(self):
        return hash((self.liquidity_pool_id, self.max_amount_a, self.max_amount_b, self.min_price, self.max_price,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.liquidity_pool_id== other.liquidity_pool_id and self.max_amount_a== other.max_amount_a and self.max_amount_b== other.max_amount_b and self.min_price== other.min_price and self.max_price== other.max_price
    def __str__(self):
        out = [
