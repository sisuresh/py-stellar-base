...
class AccountMergeResult:
    ...
    def __hash__(self):
        return hash((self.code, self.source_account_balance,))
    ...
    def __str__(self):
        ...
        out.append(f'source_account_balance={self.source_account_balance}') if self.source_account_balance is not None else None
