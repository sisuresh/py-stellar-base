...
class EvictionIterator:
    ...
    def __hash__(self):
        return hash((self.bucket_list_level, self.is_curr_bucket, self.bucket_file_offset,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.bucket_list_level== other.bucket_list_level and self.is_curr_bucket== other.is_curr_bucket and self.bucket_file_offset== other.bucket_file_offset
    def __str__(self):
        out = [
