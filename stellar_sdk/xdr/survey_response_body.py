...
class SurveyResponseBody:
    ...
    def __eq__(self, other: object):
        ...
        return self.type== other.type and self.topology_response_body_v0== other.topology_response_body_v0 and self.topology_response_body_v1== other.topology_response_body_v1
    def __str__(self):
        out = []
        out.append(f'type={self.type}')
        out.append(f'topology_response_body_v0={self.topology_response_body_v0}') if self.topology_response_body_v0 is not None else None
        out.append(f'topology_response_body_v1={self.topology_response_body_v1}') if self.topology_response_body_v1 is not None else None
