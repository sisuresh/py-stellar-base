...
class TransactionResultResult:
    ...
    def __hash__(self):
        return hash((self.code, self.inner_result_pair, self.results,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.code== other.code and self.inner_result_pair== other.inner_result_pair and self.results== other.results
    def __str__(self):
        out = []
        out.append(f'code={self.code}')
        out.append(f'inner_result_pair={self.inner_result_pair}') if self.inner_result_pair is not None else None
