...
class SetTrustLineFlagsOp:
    ...
    def __hash__(self):
        return hash((self.trustor, self.asset, self.clear_flags, self.set_flags,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.trustor== other.trustor and self.asset== other.asset and self.clear_flags== other.clear_flags and self.set_flags== other.set_flags
    def __str__(self):
        out = [
